...
#> ℹ Data updated: 2026-06-08 04:44:39 UTC
#> # A tibble: 308 × 9
...
#> ! 2026-06-08 04:44:44.902479: stats.ncaa.org returned an Akamai bot-challenge for the team stats endpoint; no data could be retrieved. This endpoint is gated and cannot be scraped without a browser session.
...
#> ! 2026-06-08 04:44:50.154944: stats.ncaa.org returned an Akamai bot-challenge for the team stats endpoint; no data could be retrieved. This endpoint is gated and cannot be scraped without a browser session.
#> data frame with 0 columns and 0 rows
```
