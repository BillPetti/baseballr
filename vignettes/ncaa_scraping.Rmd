...
description: "The latest release of the baseballr includes a function for acquiring player statistics from the NCAA's website for baseball teams across the three major divisions (I, II, III)."
opengraph:
  image:
