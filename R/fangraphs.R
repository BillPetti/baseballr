...
fg_bat_leaders <- function(x, y, league = "all", qual = "y", ind = 0, exc_p = TRUE) {
  ...
  if (ind == 0) {
    if (exc_p){
    payload <- read_html(paste0("http://www.fangraphs.com/leaders.aspx?pos=np&stats=bat&lg=", league, "&qual=", qual,
