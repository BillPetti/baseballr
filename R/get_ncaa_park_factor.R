...
#'
  ...
  get_ncaa_park_factorr <- function(teamid, years, type = "conference") {
...
get_ncaa_park_factorr(410,c(2016:2019))
  
Mmack = updated_master_ncaa_team_lu %>% filter(school_id == 410)

Mmack$division %in% unique(Mmack$division[ duplicated(Mmack$division)]) 
