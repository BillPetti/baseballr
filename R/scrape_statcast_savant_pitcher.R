...
#' @param pitcherid The MLBAM ID for the pitcher who's data you want to query.
...
scrape_statcast_savant_pitcher <- function(start_date, end_date, pitcherid) {
    ...
    tryCatch(
        ...
        warning=function(cond) {
            message(paste("URL caused a warning. Make sure your pitcherid and date range are correct:"))
