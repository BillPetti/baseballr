context("Scrape Baseball Savant Leaderboards")
...
test_that("Scrape Baseball Savant Leaderboards", {
  skip_on_cran()
  
  x <- scrape_savant_leaderboards(leaderboard = "exit_velocity_barrels", year = 2018)
