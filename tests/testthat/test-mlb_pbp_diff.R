...
cols <- c(
 "game_pk", "game_date", "index", 
 "startTime", "endTime", "isPitch",
 "type", "playId", "pitchNumber",
 "details.description", "details.event",
 "details.awayScore", "details.homeScore",
 "details.isScoringPlay", "details.hasReview",
 "details.code", "details.ballColor", 
 "details.isInPlay", "details.isStrike", 
 "details.isBall", "details.call.code",
 "details.call.description", "count.balls.start", 
 "count.strikes.start", "count.outs.start", "player.id",
 "player.link", "pitchData.strikeZoneTop",
 ...
 "hitData.launchAngle", "hitData.totalDistance", 
