...
``` r
espn_college_baseball_game_play(event_id, play_id, ...)
```
...
- play_id:
  ...
  output as `play_id` or extractable from `plays[].$ref`).
...
#> ✖ 2026-06-12 13:44:32.633211: Failed to retrieve ESPN college-baseball event play detail for event_id=401778093, play_id=4017780931
...
#> ℹ Data updated: 2026-06-12 13:44:32 UTC
#> # A tibble: 0 × 0
# }
```
