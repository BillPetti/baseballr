...
MLB typically returns zero rankings (ranking polls are a college
concept); the wrapper is provided for completeness. (College-basketball
/ football ranking equivalents live in the hoopR / wehoop / cfbfastR
packages.)
...
#> ── ESPN MLB Season Rankings Index ─────────────────── baseballr 2.0.0 ──
#> ℹ Data updated: 2026-06-08 01:56:07 UTC
#> # A tibble: 0 × 4
#> # ℹ 4 variables: league <chr>, season <int>, ranking_id <chr>,
#> #   ref <chr>
# }
```
