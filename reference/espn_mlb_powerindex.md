...
season, in long format: one row per (team x stat). Auto-paginates
through all teams. Backed by
`sports.core.api.espn.com/v2/sports/baseball/leagues/mlb/seasons/{season}/powerindex`.
Note: ESPN's power-index feed is sparsely populated for MLB and
frequently returns zero items.
...
#> ✖ 2026-06-08 11:07:55.069793: Failed to retrieve ESPN mlb powerindex for season=2025
