...
``` r
espn_college_baseball_game_broadcasts(event_id, ...)
```
...
#> 1 4017780… NA           1       TV              Television     1        
#> 2 4017780… NA           4       Streaming       Streaming      1        
#> # ℹ 4 more variables: market_type <chr>, names <chr>, lang <chr>,
#> #   region <chr>
# }
```
