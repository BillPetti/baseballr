...
#> ℹ Data updated: 2026-06-12 03:18:23 UTC
#> # A tibble: 863 × 520
#>    Season team_name Throws xMLBAMID PlayerNameRoute PlayerName  playerid
#>     <int> <chr>     <chr>     <int> <chr>           <chr>          <int>
#>  1   2023 PHI       R        554430 Zack Wheeler    Zack Wheel…    10310
#>  2   2023 ATL       R        675911 Spencer Strider Spencer St…    27498
#>  3   2023 MIN       R        543243 Sonny Gray      Sonny Gray     12768
#>  4   2023 NYY       R        543037 Gerrit Cole     Gerrit Cole    13125
#>  5   2023 TOR       R        592332 Kevin Gausman   Kevin Gaus…    14107
#>  6   2023 ARI       R        668678 Zac Gallen      Zac Gallen     19291
#>  7   2023 SFG       R        657277 Logan Webb      Logan Webb     17995
#>  8   2023 TBR       R        621107 Zach Eflin      Zach Eflin     13774
#>  9   2023 CHC       L        657006 Justin Steele   Justin Ste…    17312
#> 10   2023 MIN       R        641154 Pablo Lopez     Pablo López    17085
#> # ℹ 853 more rows
#> # ℹ 513 more variables: Age <int>, AgeRng <chr>, SeasonMin <int>,
#> #   SeasonMax <int>, W <int>, L <int>, ERA <dbl>, G <int>, GS <int>,
#> #   QS <int>, CG <int>, ShO <int>, SV <int>, BS <int>, IP <dbl>,
#> #   TBF <int>, H <int>, R <int>, ER <int>, HR <int>, BB <int>,
#> #   IBB <int>, HBP <int>, WP <int>, BK <int>, SO <int>, GB <int>,
