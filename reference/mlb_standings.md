...
- standings_type:
  ...
  The standings_type(s) to return standings information for.
  **Description of all standings_types**
  ...
  5.  firstHalf - First half standings. Only valid for leagues with a
      split season (Mexican League).

  6.  secondHalf - Second half standings. Only valid for leagues with a
      split season (Mexican League).
...
#> ℹ Data updated: 2026-06-12 11:42:56 UTC
#> # A tibble: 15 × 57
