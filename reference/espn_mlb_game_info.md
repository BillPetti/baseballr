...
Returns one wide row of game metadata from the ESPN game-summary
`gameInfo` block: venue, attendance, game duration, and the umpire crew
(home-plate, first-, second-, and third-base umpires).
...
#> ℹ Data updated: 2026-06-08 04:38:34 UTC
#> # A tibble: 1 × 11
#>     game_id venue_id venue_name  venue_city venue_state attendance
#>       <int> <chr>    <chr>       <chr>      <chr>            <int>
#> 1 401570000 27       Coors Field Denver     Colorado         36579
#> # ℹ 5 more variables: game_duration <chr>, home_plate_umpire <chr>,
#> #   first_base_umpire <chr>, second_base_umpire <chr>,
#> #   third_base_umpire <chr>
# }
```
