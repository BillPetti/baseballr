...
``` r
espn_college_baseball_game_team_score(event_id, team_id, ...)
```
...
#> ── ESPN COLLEGE-BASEBALL Event Competitor Score ───── baseballr 2.0.0 ──
...
#> 1 college-baseball 4017780… 113         2 2             FALSE  1        
