...
Returns the list of group IDs (conferences / divisions) for one (MLB
...
#> ── ESPN MLB Season Groups Index ───────────────────── baseballr 2.0.0 ──
#> ℹ Data updated: 2026-06-12 12:23:43 UTC
#> # A tibble: 4 × 5
#>   league season season_type group_id ref                                
#>   <chr>   <int>       <int> <chr>    <chr>                              
#> 1 mlb      2025           2 7        http://sports.core.api.espn.com/v2…
#> 2 mlb      2025           2 8        http://sports.core.api.espn.com/v2…
#> 3 mlb      2025           3 7        http://sports.core.api.espn.com/v2…
#> 4 mlb      2025           3 8        http://sports.core.api.espn.com/v2…
# }
```
