...
``` r
espn_college_baseball_tournament(tournament_id, ...)
```
...
#> ✖ 2026-06-12 14:08:12.113685: Failed to retrieve ESPN college-baseball tournament 1
#> ✖ Args: league = "college-baseball", tournament_id = 1
#> ✖ Error: The API returned an error, HTTP Response Code 400
#> ── ESPN COLLEGE-BASEBALL Tournament Detail ────────── baseballr 2.0.0 ──
#> ℹ Data updated: 2026-06-12 14:08:12 UTC
#> # A tibble: 0 × 0
# }
```
