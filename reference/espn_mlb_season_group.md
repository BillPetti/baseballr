...
Returns metadata for one group (conference or division) in one (MLB
...
#> 1 mlb      2025           2 5        s:1~… Nati… NLC          NL Cent   
#> # ℹ 7 more variables: midsize_name <chr>, is_conference <lgl>,
#> #   slug <chr>, parent_ref <chr>, children_ref <chr>, teams_ref <chr>,
#> #   standings_ref <chr>
# }
```
