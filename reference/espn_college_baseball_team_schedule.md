...
#>  1 401750605   2025          NA    NA 2025… Ohio… OSU @ ASU  NA         
#>  2 401750606   2025          NA    NA 2025… Ohio… OSU @ ASU  NA         
#>  3 401750607   2025          NA    NA 2025… Ohio… OSU @ ASU  NA         
#>  4 401750608   2025          NA    NA 2025… Aust… APSU @ ASU NA         
#>  5 401750609   2025          NA    NA 2025… Oral… ORU @ ASU  NA         
#>  6 401750610   2025          NA    NA 2025… Oral… ORU @ ASU  NA         
#>  7 401750611   2025          NA    NA 2025… Oral… ORU @ ASU  NA         
#>  8 401750612   2025          NA    NA 2025… Ariz… ASU @ UCLA NA         
#>  9 401750613   2025          NA    NA 2025… Ariz… ASU @ UCLA NA         
#> 10 401751014   2025          NA    NA 2025… Minn… MINN @ ASU NA         
#> # ℹ 47 more rows
#> # ℹ 13 more variables: opponent_abbrev <chr>, home_away <chr>,
#> #   neutral_site <lgl>, conference_competition <lgl>, venue_id <chr>,
#> #   venue_name <chr>, venue_city <chr>, venue_state <chr>,
#> #   broadcast <chr>, result <chr>, team_score <chr>,
#> #   opponent_score <chr>, winner <lgl>
# }
```
