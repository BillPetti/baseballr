...
``` r
espn_college_baseball_game_official_detail(event_id, order, ...)
```
...
#> ✖ 2026-06-12 12:13:54.577067: Failed to retrieve ESPN college-baseball event official detail for event_id=401778093, order=1
...
#> ℹ Data updated: 2026-06-12 12:13:54 UTC
#> # A tibble: 0 × 0
# }
```
