...
#> ℹ Data updated: 2026-06-12 11:22:25 UTC
#> # A tibble: 94 × 17
#>    league athlete_id stat_type_id split_id split_name split_type
#>    <chr>  <chr>      <chr>        <chr>    <chr>      <chr>     
#>  1 mlb    33192      0            0        All Splits NA        
#>  2 mlb    33192      0            0        All Splits NA        
#>  3 mlb    33192      0            0        All Splits NA        
#>  4 mlb    33192      0            0        All Splits NA        
#>  5 mlb    33192      0            0        All Splits NA        
#>  6 mlb    33192      0            0        All Splits NA        
#>  7 mlb    33192      0            0        All Splits NA        
#>  8 mlb    33192      0            0        All Splits NA        
#>  9 mlb    33192      0            0        All Splits NA        
#> 10 mlb    33192      0            0        All Splits NA        
#> # ℹ 84 more rows
#> # ℹ 11 more variables: category_name <chr>, category_display <chr>,
#> #   category_short <chr>, category_abbrev <chr>, stat_name <chr>,
#> #   stat_abbrev <chr>, stat_display <chr>, stat_short <chr>,
...
#> ── ESPN MLB Athlete Career Stats ──────────────────── baseballr 2.0.0 ──
#> ℹ Data updated: 2026-06-12 11:22:26 UTC
#> # A tibble: 59 × 17
#>    league athlete_id stat_type_id split_id split_name     split_type
#>    <chr>  <chr>      <chr>        <chr>    <chr>          <chr>     
#>  1 mlb    33192      2            2        Boston Red Sox NA        
#>  2 mlb    33192      2            2        Boston Red Sox NA        
#>  3 mlb    33192      2            2        Boston Red Sox NA        
#>  4 mlb    33192      2            2        Boston Red Sox NA        
#>  5 mlb    33192      2            2        Boston Red Sox NA        
#>  6 mlb    33192      2            2        Boston Red Sox NA        
#>  7 mlb    33192      2            2        Boston Red Sox NA        
#>  8 mlb    33192      2            2        Boston Red Sox NA        
#>  9 mlb    33192      2            2        Boston Red Sox NA        
#> 10 mlb    33192      2            2        Boston Red Sox NA        
#> # ℹ 49 more rows
#> # ℹ 11 more variables: category_name <chr>, category_display <chr>,
#> #   category_short <chr>, category_abbrev <chr>, stat_name <chr>,
#> #   stat_abbrev <chr>, stat_display <chr>, stat_short <chr>,
