...
Returns the game-day roster index for one team in one MLB event. Each
...
Note: ESPN's core-v2 per-game competitor roster is not populated for MLB
and typically returns an empty tibble; use
...
#> ✖ 2026-06-12 11:55:35.357002: Failed to retrieve ESPN mlb competitor roster for event_id=401283399, team_id=29
#> ✖ Args: league = "mlb", event_id = 401283399, team_id = 29
#> ✖ Error: The API returned an error, HTTP Response Code 404
#> ── ESPN MLB Competitor Roster ─────────────────────── baseballr 2.0.0 ──
#> ℹ Data updated: 2026-06-12 11:55:35 UTC
#> # A tibble: 0 × 0
# }
```
