...
``` r
espn_college_baseball_game_team_records(event_id, team_id, ...)
```
...
#> ── ESPN COLLEGE-BASEBALL Competitor Records ───────── baseballr 2.0.0 ──
#> ℹ Data updated: 2026-06-12 14:07:54 UTC
#> # A tibble: 1 × 11
#>   league      event_id team_id record_id name  abbreviation display_name
#>   <chr>       <chr>    <chr>   <chr>     <chr> <chr>        <chr>       
#> 1 college-ba… 4017780… 113     1         over… Ytd          Record Year…
#> # ℹ 4 more variables: short_display_name <chr>, type <chr>,
#> #   summary <chr>, value <dbl>
# }
```
