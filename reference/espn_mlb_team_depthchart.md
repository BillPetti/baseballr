...
rank × athlete). MLB-only at ESPN's core-v2.
...
#> ℹ Data updated: 2026-06-08 04:39:00 UTC
#> # A tibble: 96 × 10
#>    league team_id season depthchart_id depthchart_name position  rank
#>    <chr>  <chr>    <int> <chr>         <chr>           <chr>    <int>
#>  1 mlb    13        2025 1             Depth Chart     rp           1
#>  2 mlb    13        2025 1             Depth Chart     rp           2
#>  3 mlb    13        2025 1             Depth Chart     rp           3
#>  4 mlb    13        2025 1             Depth Chart     rp           4
#>  5 mlb    13        2025 1             Depth Chart     rp           5
#>  6 mlb    13        2025 1             Depth Chart     rp           6
#>  7 mlb    13        2025 1             Depth Chart     rp           7
#>  8 mlb    13        2025 1             Depth Chart     rp           8
#>  9 mlb    13        2025 1             Depth Chart     rp           9
#> 10 mlb    13        2025 1             Depth Chart     p            1
#> # ℹ 86 more rows
#> # ℹ 3 more variables: athlete_id <chr>, athlete_ref <chr>,
#> #   position_ref <chr>
# }
```
