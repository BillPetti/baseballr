...
``` r
espn_college_baseball_player_seasons(athlete_id, ...)
```
...
#> ✖ 2026-06-24 02:04:23.469835: Failed to retrieve ESPN college-baseball athlete seasons for athlete_id=3730
...
#> ℹ Data updated: 2026-06-24 02:04:23 UTC
#> # A tibble: 0 × 0
# }
```
