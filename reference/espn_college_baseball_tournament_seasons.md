...
``` r
espn_college_baseball_tournament_seasons(tournament_id, ...)
```
...
#> ✖ 2026-06-12 11:22:06.071688: Failed to retrieve ESPN college-baseball tournament 1 seasons
...
#> ℹ Data updated: 2026-06-12 11:22:06 UTC
#> # A tibble: 0 × 0
# }
```
