...
#> 1 college-…   2025           2     2 Regu… reg           2025 2025-01-1…
#> # ℹ 8 more variables: end_date <chr>, has_groups <lgl>,
#> #   has_standings <lgl>, has_legs <lgl>, slug <chr>, groups_ref <chr>,
#> #   weeks_ref <chr>, leaders_ref <chr>
# }
```
