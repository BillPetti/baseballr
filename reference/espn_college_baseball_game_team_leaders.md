...
``` r
espn_college_baseball_game_team_leaders(event_id, team_id, ...)
```
...
#> ✖ 2026-06-12 12:23:01.048553: Failed to retrieve ESPN college-baseball competitor leaders for event_id=401778093, team_id=113
