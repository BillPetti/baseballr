...
#> ℹ Data updated: 2026-06-12 13:45:24 UTC
#> # A tibble: 60 × 13
#>    league team_id season season_type category_type    category_abbrev
#>    <chr>  <chr>    <int>       <int> <chr>            <chr>          
#>  1 mlb    13        2026           0 moneyLineOverall ML             
#>  2 mlb    13        2026           0 moneyLineOverall ML             
#>  3 mlb    13        2026           0 moneyLineOverall ML             
#>  4 mlb    13        2026           0 moneyLineOverall ML             
#>  5 mlb    13        2026           0 moneyLineOverall ML             
#>  6 mlb    13        2026           0 moneyLineOverall ML             
#>  7 mlb    13        2026           0 moneyLineHome    ML HOME        
#>  8 mlb    13        2026           0 moneyLineHome    ML HOME        
#>  9 mlb    13        2026           0 moneyLineHome    ML HOME        
#> 10 mlb    13        2026           0 moneyLineHome    ML HOME        
#> # ℹ 50 more rows
#> # ℹ 7 more variables: category_short <chr>, category_display <chr>,
#> #   stat_type <chr>, stat_abbrev <chr>, stat_display <chr>,
