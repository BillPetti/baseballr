...
#> ℹ Data updated: 2026-06-12 12:39:32 UTC
#> # A tibble: 9 × 2
#>   name           display_name 
#>   <chr>          <chr>        
#> 1 split          Overall      
#> 2 byBreakdown    Breakdown    
#> 3 byDayMonth     Day / Month  
#> 4 byOpponent     Opponent     
#> 5 byArena        Stadium      
#> 6 byPosition     Position     
#> 7 byCount        Count        
#> 8 byBattingOrder Batting Order
#> 9 bySituation    Situation    
# }
```
