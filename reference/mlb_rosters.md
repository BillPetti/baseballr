...
- team_id:
  ...
  team_id to return team roster information for a particular club. Look
  up ids with
  [`mlb_teams()`](https://billpetti.github.io/baseballr/reference/mlb_teams.md)
  – e.g. `mlb_teams(season = 2025, sport_ids = 1)` returns `team_id`
  alongside `team_full_name`.
...
#> ℹ Data updated: 2026-08-26 20:08:20 UTC
#> # A tibble: 49 × 15
