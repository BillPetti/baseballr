...
``` r
espn_college_baseball_game_play_personnel(event_id, play_id, ...)
```
...
#> ✖ 2026-06-12 11:21:39.023863: Failed to retrieve ESPN college-baseball play personnel for event_id=401778093, play_id=4017780931
...
#> ℹ Data updated: 2026-06-12 11:21:39 UTC
#> # A tibble: 0 × 0
# }
```
