...
``` r
espn_college_baseball_game_officials(event_id, ...)
```
...
#> ✖ 2026-06-12 11:21:38.410202: Failed to retrieve ESPN college-baseball event officials for event_id=401778093
