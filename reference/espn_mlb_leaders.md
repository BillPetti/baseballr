...
#> ℹ Data updated: 2026-06-12 11:22:23 UTC
#> # A tibble: 500 × 11
#>    season season_type category abbreviation athlete_id athlete_name
#>     <int>       <int> <chr>    <chr>        <chr>      <chr>       
#>  1   2024           2 avg      AVG          42403      NA          
#>  2   2024           2 avg      AVG          35002      NA          
#>  3   2024           2 avg      AVG          33192      NA          
#>  4   2024           2 avg      AVG          39572      NA          
#>  5   2024           2 avg      AVG          39832      NA          
#>  6   2024           2 avg      AVG          36018      NA          
#>  7   2024           2 avg      AVG          31668      NA          
#>  8   2024           2 avg      AVG          4781491    NA          
#>  9   2024           2 avg      AVG          33710      NA          
#> 10   2024           2 avg      AVG          31662      NA          
#> # ℹ 490 more rows
#> # ℹ 5 more variables: team_id <chr>, team_abbrev <chr>, value <dbl>,
#> #   rank <int>, display_value <chr>
# }
```
