...
Returns the probable / announced starting pitchers for a game, one row
per team, parsed from the ESPN game-summary
`header.competitions.competitors` `probables` block. Available for
...
#> ℹ Data updated: 2026-06-12 11:41:06 UTC
#> # A tibble: 2 × 15
#>   game_id season season_type team_id team_abbreviation team_display_name
#>     <int>  <int>       <int>   <int> <chr>             <chr>            
#> 1  4.02e8   2024           2      27 COL               Colorado Rockies 
#> 2  4.02e8   2024           2       2 BOS               Boston Red Sox   
#> # ℹ 9 more variables: home_away <chr>, athlete_id <int>,
#> #   athlete_full_name <chr>, athlete_display_name <chr>,
#> #   athlete_short_name <chr>, jersey <chr>, position <chr>,
#> #   throws <chr>, headshot_href <chr>
# }
```
