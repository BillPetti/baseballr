...
Returns the index of MLB-branded tournaments tracked by ESPN (e.g. the
...
# \donttest{
  espn_mlb_tournaments()
#> ✖ 2026-06-12 12:14:54.618961: Failed to retrieve ESPN mlb tournaments
#> ✖ Args: league = "mlb"
#> ✖ Error: The API returned an error, HTTP Response Code 400
#> ── ESPN MLB Tournaments Index ─────────────────────── baseballr 2.0.0 ──
#> ℹ Data updated: 2026-06-12 12:14:54 UTC
#> # A tibble: 0 × 0
# }
```
